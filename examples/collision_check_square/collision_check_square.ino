...
uint8_t object1W = 5;     //object 1 Width
uint8_t object1H = 5;     //object 1 Height
uint8_t object2X = 128;   //object 2 X
uint8_t object2Y = 10;    //object 2 Y
uint8_t object2W = 5;     //object 2 Width
uint8_t object2H = 5;     //object 2 Height
...
void loop() {
  ...
  collis1Result = col1Check.collisionCheckSquareToSquare(object1X, object1Y, object1W, object1H, object2X, object2Y, object2W, object2H);
  if (collis1Result) {
